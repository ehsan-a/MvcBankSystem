        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstPassword = table.Column<int>(type: "int", nullable: false),
                    SecondPassword = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DebtorAccountId = table.Column<int>(type: "int", nullable: false),
                    CreditorAccountId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transaction_Account_CreditorAccountId",
                        column: x => x.CreditorAccountId,
                        principalTable: "Account",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transaction_Account_DebtorAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transaction_CreditorAccountId",
                table: "Transaction",
                column: "CreditorAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Transaction_DebtorAccountId",
                table: "Transaction",
